...
pref("nglayout.compatibility.mode", 1);
...
//pref("browser.download.antivirus.dontclean", false);
...
//custom pref used with SSL certificate handling, determines whether or not
//to navigate to the about:neterror page when a certificate error occurs.
////////////////////////////////////////////////////////////////////////////
pref("network.invalid_ssl_certificate.navigate_neterror", true);
////////////////////////////////////////////////////////////////////////////

////////////////////////////////////////////////////////////////////////////
//custom prefs used for highlighting with the find feature
pref("moznet.find_hilite.find_css",".moznet_hilite_find {z-index:100; -moz-border-radius:4px; border: solid 1px black;background: -moz-linear-gradient(left, #b4e391 0%, #61c419 7%, #61c419 93%, #b4e391 100%);display: inline;font-size: inherit;margin-bottom:2px;padding: 0px 1px 1px 1px;position: relative;color:White;}");
pref("moznet.find_hilite.find_all_css",".moznet_hilite_find_all { -moz-border-radius:4px; border: 1px solid black; background: -moz-linear-gradient(top, #fceabb 0%, #fccd4d 62%, #f8b500 67%, #fbdf93 100%);display: inline;font-size: inherit;margin-bottom:2px; padding: 0px 1px 1px 1px;position: relative;color:Black;}");
pref("moznet.find_hilite.search_results_css",".moznet_hilite_search_results {-moz-border-radius:4px;border: 1px solid black;background: -moz-linear-gradient(top, #fceabb 0%, #fccd4d 50%, #f8b500 51%, #fbdf93 100%);display: inline;font-size: inherit;padding: 0px 1px 1px 1px;position: relative;color:Black;}");
pref("moznet.find_hilite.search_results_alt_css", ".moznet_hilite_search_results_alt {-moz-border-radius:4px;border: 1px solid black;background: -moz-linear-gradient(top, #ffb76b 0%, #ffa73d 50%, #ff7c00 51%, #ff7f04 100%);display: inline;font-size: inherit;padding: 0px 1px 1px 1px;position: relative;color:Black;}");
pref("moznet.find_hilite.search_results_alt2_css",".moznet_hilite_search_results_alt2{-moz-border-radius:4px;border: 1px solid black;background: -moz-linear-gradient(top, #f5f6f6 0%, #dbdce2 21%, #b8bac6 49%, #dddfe3 80%, #f5f6f6 100%);display: inline;font-size: inherit;padding: 0px 1px 1px 1px;position: relative;color:Black;}");
////////////////////////////////////////////////////////////////////////////

//custom pref for HomePage property
pref("moznet.browser.homePage", "http://www.google.com/");

//custom prefs for global settings
pref("moznet.global_settings.wifi_mgnt_enabled", false);
...
//run protocol on the external default application
pref("network.protocol-handler.external.mailto", true); // for mail
pref("network.protocol-handler.external.sip", true);   // for sip
pref("network.protocol-handler.external.news", true);   // for news
pref("network.protocol-handler.external.snews", true);  // for secure news
pref("network.protocol-handler.external.nntp", true);   // also news
pref("network.protocol-handler.external.callto", true); //custom added to handle 'callto://' links with skype
// ...without warning dialogs
pref("network.protocol-handler.warn-external.mailto", false);
pref("network.protocol-handler.warn-external.sip", false);
pref("network.protocol-handler.warn-external.news", false);
pref("network.protocol-handler.warn-external.snews", false);
pref("network.protocol-handler.warn-external.nntp", false);
pref("network.protocol-handler.warn-external.callto", false);

//optionally specify a specific application that should handle the protocol. You can follow suite to add more protocols here..
pref("network.protocol-handler.app.mailto", ""); //"C:\Program Files\Microsoft Office\Office14\outlook.exe"
